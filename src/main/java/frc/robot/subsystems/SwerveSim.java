...
public class SwerveSim extends SwerveModule{
    ...
    public SwerveModuleState getsimState(){
        return new SwerveModuleState(
                simdriveEncoder.getPosition()* WHEEL_CIRCUMFERENCE *driveGearing,new Rotation2d(simturnEncoder.getAbsolutePosition()/(2*Math.PI))); // Apparently the position needs to be in radians
    }
